...
document.addEventListener('DOMContentLoaded', () => {
    ...
    initializeTypingEffect(); // 모든 콘텐츠 로드 후 타이핑 효과 시작
});
...
function initializeTypingEffect() {
    ...
    if (targetElement && typeof Typed !== 'undefined') {
        // aboutContent 객체에서 두 문단을 가져와 합칩니다.
        // LocalStorage에 저장된 \n(줄바꿈)을 HTML의 <br> 태그로 변환합니다.
        const paragraph1Html = aboutContent.paragraph1.replace(/\n/g, '<br>');
        const fullText = `${paragraph1Html}<br><br>${aboutContent.paragraph2}`;
